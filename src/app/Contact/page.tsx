        ...
        <div className='  m-4 p-2  rounded-xl text-white  md:m-32 md:mt-5'>
          ...
          <div>
            ...
            <div className="m-5">
              ...
              <div className="dropdown inline-block relative w-full">
                ...
                <ul className={`dropdown-menu  ${isOpen ? "" : "hidden"}  text-gray-700 pt-1`}>
                  <li onClick={() => { setCategory("Project related"); setIsOpen(false) }} className=""><a className="rounded-t bg-gray-200 hover:bg-gray-400 py-2 px-4 block whitespace-no-wrap" >Project related</a></li>
                  <li onClick={() => { setCategory("Referals"); setIsOpen(false) }} className=""><a className="bg-gray-200 hover:bg-gray-400 py-2 px-4 block whitespace-no-wrap" >Referals</a></li>
                  <li onClick={() => { setCategory("Personal Tips"); setIsOpen(false) }} className=""><a className="rounded-b bg-gray-200 hover:bg-gray-400 py-2 px-4 block whitespace-no-wrap" >Personal Tips</a></li>
                </ul>
              </div>
            ...
            <div className='m-5'>
              ...
              <textarea id="first_name" className="bg-gray-50 border  text-gray-900 text-sm rounded-lg  w-full p-2.5  h-[200px]" placeholder="John" required onChange={(e) => setDesc(e.target.value)}></textarea>
            </div>
