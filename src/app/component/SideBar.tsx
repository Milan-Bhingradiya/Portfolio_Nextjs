    ...
    <>
      ...
      <div className={` h-[100vh] ${isWide ? "w-[150px]" : "w-[0px]"} sm:${isWide ? "w-[300px]" : "w-[0px]"}  transition-all duration-700 ease-out  overflow-hidden  text-2xl text-white flex flex-col justify-center items-center  absolute top-0 right-0 `}>
        ...
        <Link href={"/"} onClick={() => {handleOnClick("/");}}>
          {" "}
          <div className={`m-4 ${(currentPage=="/")?'font-bold text-3xl  transition-all duration-300':''}` }>
            Home
          </div>
        </Link>
        ...
        {/* ------------------------------------------------------------------------------------------------------------- */}
        <Link href={"/projects"}   onClick={() => { handleOnClick("Projects");}}>
          <div className={`m-4 ${(currentPage=="Projects")?'font-bold text-3xl  transition-all duration-300':'hover:font-semibold'} ` }>
            Projects
          </div>
        </Link>
        ...
        <Link href={"/Contact"}  onClick={() => {handleOnClick("Contact");}}>
          <div className={`m-4 ${(currentPage=="Contact")?'font-bold text-3xl  transition-all duration-300':'hover:font-semibold'}` }>
            Contact
          </div>
        </Link>
