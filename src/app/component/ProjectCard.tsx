    ...
    >
      ...
      <div className="content flex flex-col relative  text-red ">
        ...
        <div className="  h-[300px] overflow-hidden">
          ...
          <div
            className="m-2 mt-4   font-thin text-wrap text-white"
            style={{ fontSize: "14px" }}
          >
                ...
                project.technology &&
                  project.technology.map((tech: string) => {
                    return (
                      <div
                        key={tech}
                        className=" bg-gray-800  m-1  rounded-md font-semibold  h-auto  px-2 w-auto  text-teal-500"
                      >
                        {"#" + tech}
                      </div>
                    );
        ...
        {/* second page data */}
        <div
          className={`absolute bottom-0 left-0 w-full rounded-[19px] text-white   bg-[#011522] transition-all duration-500 ease-in-out ${
